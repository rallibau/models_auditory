...
class OneSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = ModelOne
        fields = ['id', 'field_1', 'field_2', 'field_2', 'field_3', 'field_4', 'field_5', 'field_6', 'field_7',
                  'field_8',
...
class AuditorySerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = AuditoryModel
        fields = ['date', 'user', 'model', 'model_instance_id', 'data_before_change', 'data_after_change']
